...
# 기본 설정으로 로그를 남길 수 있는 객체를 로거객체를 가져와 langchain_classic.retriever.multi_query의
...
# multi_retriever로 검색된 다양한 응답의 내용을 랭체인을 이용하여 llm에게 주고, 종합적인 응답을
# 받도록 한다.

...
# ── 실행 ─────────────────────────────────────────────────────────
# 실습용 파일 3가지 생성 (시나리오별)
make_test_wav("radio_normal.wav",    duration=2.0)  # 정상 상황
make_test_wav("radio_warning.wav",   duration=3.0)  # 주의 상황
make_test_wav("radio_emergency.wav", duration=4.0)  # 긴급 상황

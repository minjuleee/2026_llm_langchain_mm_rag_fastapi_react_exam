...
def base64_to_image(b64:str, save_path:str="./vision_sample/decode_exam.jpeg") -> None:
  """
  Base64 문자열을 이미지 파일로 디코딩하여 저장한다.
  """
  image_bytes = base64.b64decode(b64)
  output_path = Path(save_path)
  output_path.parent.mkdir(parents=True, exist_ok=True)   # 폴더 없으면 생성
  output_path.write_bytes(image_bytes)   # bytes -> file write
